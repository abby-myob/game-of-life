...
namespace GameOfLifeTests
{
    public class CellTests
    {
        ...
        [Fact]
        public void Live_cell_should_be_dead_with_more_than_three_neighbours()
        {
            Cell cell = new Cell(true);
            List<Cell> neighbours = new List<Cell>()
            {
            ...
            Assert.False(cell.isAliveInNewWorld(neighbours));
        }

        [Fact]
        public void Live_cell_should_be_alive_with_two_neighbours()
        {
            Cell cell = new Cell(true);
            List<Cell> neighbours = new List<Cell>()
            {
            ...
            Assert.True(cell.isAliveInNewWorld(neighbours));
        }

        [Fact]
        public void Live_cell_should_be_alive_with_three_neighbours()
        {
            Cell cell = new Cell(true);
            List<Cell> neighbours = new List<Cell>()
            {
        ...
        [Fact]
        public void Dead_cell_should_revive_with_three_neighbours()
        {
        ...
        [Fact]
        public void Dead_cell_should_die_with_less_than_three_neighbours()
        {
            Cell cell = new Cell(false);
            List<Cell> neighbours = new List<Cell>()
            {
